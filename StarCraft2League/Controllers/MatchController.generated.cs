...
namespace StarCraft2League.Controllers
{
    public partial class MatchController
    {
        ...
        [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
        public MatchController Actions => MVC.Match;
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Area = "";
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Name = "Match";
        [GeneratedCode("R4Mvc", "1.0")]
        public const string NameConst = "Match";
        [GeneratedCode("R4Mvc", "1.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Views/Match/Edit.cshtml";
        }
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_MatchController : StarCraft2League.Controllers.MatchController
    {
        public R4MVC_MatchController(): base(Dummy.Instance)
        {
        }
        ...
        [NonAction]
        public override Microsoft.AspNetCore.Mvc.ActionResult Edit(StarCraft2League.Models.Seasons.Match match)
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "match", match);
            EditOverride(callInfo, match);
            return callInfo;
        }
    }
}
